...
export class MemoryManager {
    ...
    private generateRedisCompanionKey(characterKey: CharacterKey): string {
        return `${characterKey.companionName}-${characterKey.modelName}-${characterKey.userId}`;
    }
    ...
    public async readLatestHistory(characterKey: CharacterKey): Promise<string> {
        ...
        const key = this.generateRedisCompanionKey(characterKey);
