                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <FormField name="description" control={form.control} render={({field}) => (
                            <FormItem className="col-span-2 md:col-span-1">
                                ...
                                <FormControl>
                                    <Input disabled={isLoading} placeholder="CEO & Founder of Tesla, SpaceX and Paypal" {...field} />
                                </FormControl>
                                <FormDescription>
                    ...
                    <FormField name="instructions" control={form.control} render={({field}) => (
                        <FormItem className="col-span-2 md:col-span-1">
                            ...
                            <FormControl>
                                <Textarea disabled={isLoading} placeholder={PREAMBLE} {...field} rows={7} className="bg-background resize-none" />
                            </FormControl>
                            <FormDescription>
                    ...
                    <FormField name="seed" control={form.control} render={({field}) => (
                        <FormItem className="col-span-2 md:col-span-1">
                            ...
                            <FormControl>
                                <Textarea disabled={isLoading} placeholder={SEED_CHAT} {...field} rows={7} className="bg-background resize-none" />
                            </FormControl>
                            <FormDescription>
                                Describe in detail your character&apos;s backstory and relevant details.
                            </FormDescription>
